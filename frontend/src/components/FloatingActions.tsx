  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4">
        ...
        {isOpen && (
          <div className="flex flex-col items-end gap-3 mb-2">
            {actions.map((action, index) => (
              ...
              >
                <span className="px-4 py-2 bg-white dark:bg-slate-800 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-100 shadow-sm opacity-100 transition-opacity">
                  {action.label}
                </span>
      ...
      <button
        ...
        aria-label={isOpen ? '收起快捷操作' : '展开快捷操作'}
